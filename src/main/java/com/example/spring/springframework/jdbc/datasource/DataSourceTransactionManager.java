package com.example.spring.springframework.jdbc.datasource;

import com.example.spring.springframework.beans.factory.InitializingBean;
import com.example.spring.springframework.tx.transaction.CannotCreateTransactionException;
import com.example.spring.springframework.tx.transaction.TransactionDefinition;
import com.example.spring.springframework.tx.transaction.TransactionException;
import com.example.spring.springframework.tx.transaction.support.AbstractPlatformTransactionManager;
import com.example.spring.springframework.tx.transaction.support.DefaultTransactionStatus;
import com.example.spring.springframework.tx.transaction.support.TransactionSynchronizationManager;
